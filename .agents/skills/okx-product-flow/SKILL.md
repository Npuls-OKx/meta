...
3. **Onafhankelijke review, eigen sporen, verse contexten.** Geef elke reviewer alleen het requirements-document, het deliverable en zijn skill; niet de makende conversatie.
   - **Tester**: [`okx-requirements-tester`](../okx-requirements-tester/SKILL.md) toetst eis-voor-eis; bij scripts en valideerbare definities loopt hij de testgevallen van `okx-test-persona` één voor één af.
