...
1. **WP1, hoofddocument opknippen (branch 137, rondt #137 af).** §1-2 ("Wat is OKx", deliverable-keten) vervangen door een korte verwijzing naar `doc/OKx_Projectoverzicht.md`; de AMIGO-passages naar een eigen kort document of een verwijzing naar de [architectuurprincipes (OKx-AP03)](https://github.com/Npuls-OKx/Public/blob/dev/Referentiemateriaal/principes/principes.md) en de [amigo-aanpak-skill](../../../.agents/skills/amigo-aanpak/SKILL.md); het hoofddocument houdt inleiding, leerroutes en delta's. Daarmee is PR 140 wél reviewklaar.
2. **WP2, beslispunt laagvolgorde en id-conventie (stopmoment, #143).** Kort beslisdocument met opties en impact. Laagvolgorde: (a) de huidige volgorde behouden en de story-scenario-relatie via bronnen en "Raakt ook" dragen, of (b) de boom herschikken naar opdracht, epic, story, feature zoals Niek schetst (17:14, 43:21). Id-conventie: het overleg schetst letterprefixen U, R, E, F en S met gelaagde nummering (41:40-42:24), terwijl PR 136 een soort-nummer-patroon voorstelt (bijvoorbeeld `eis-001`); dat verschil moet beslecht. Besluit door Niek, met Niels; daarna pas doorwerking in WP3 en verder.
3. **WP3, scenario-story-verantwoording (#143, na het WP2-besluit).** Elk scenariodocument krijgt een sectie "Verantwoordt" met de story-id's die eruit volgen; elke story in de boom krijgt het scenario als bron of nevenbron. De kolom "Raakt ook" draagt de meervoudige relaties; de harde eis blijft herleidbaarheid naar minimaal één epic (43:45-44:08). Het mechanisme is volgordeonafhankelijk, maar de id's volgen het WP2-besluit; daarom eerst beslissen, dan invullen.
...
- WP2: besluit over laagvolgorde en id-conventie vastgelegd, in het beslisdocument of als architectuurbesluit (ADR), vóór enige herschikking of hernummering van de boom.
...
Plan opgesteld en tegengelezen; wacht op review door Niek (#143). Eerste stap bij oppakken: WP1 uitvoeren en het WP2-beslisdocument (laagvolgorde en id-conventie) voorleggen; na het besluit volgt WP3, de scenario-story-verantwoording.
