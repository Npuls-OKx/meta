...
| vr 18 sep | Akkoord op het plan en de drie keuzes; basis (A of B); sub-issues en milestone; agendaslot en reserve-verzender bevestigen; features 1, 2, 3a in uitvoering; pdf-export proefdraaien op een bestaand deck | agent; modelleur (één dagdeel: akkoord, basis, agendaslot) | Akkoord op plan en keuzes |
