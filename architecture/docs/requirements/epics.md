...
|---|---|---|---|---|---|
| E1 | Onderwijsaanbod specificeren en ontsluiten | Elke ketenpartij werkt met dezelfde actuele onderwijsspecificaties en hetzelfde aanbod uit de onderwijscatalogus. | D3 | [Scenario-uitwerkingen §3.4.1](../specificatie/leerroute-uitwerking/doc/scenario-uitwerkingen.md#341-scenario-11--regulier-happyflow) | [features](features.md#onderwijsaanbod-specificeren-en-ontsluiten) |
...
| E3 | Aanbod plannen en roosteren | Studenten krijgen tijdig haalbaar, gefaseerd en geroosterd aanbod, met heldere terugkoppeling op hun keuzes. | D3 | [Scenario-uitwerkingen §3.4.1](../specificatie/leerroute-uitwerking/doc/scenario-uitwerkingen.md#341-scenario-11--regulier-happyflow) | [features](features.md#aanbod-plannen-en-roosteren) |
