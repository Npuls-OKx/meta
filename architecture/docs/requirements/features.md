...
|---|---|---|---|---|
| F1.1 | Catalogus vullen vanuit curriculumontwerp | Alle ketenpartijen vertrouwen op één actuele, formeel vastgestelde bron voor het onderwijsaanbod. | [ADR 0002](https://github.com/Npuls-OKx/Public/blob/dev/Referentiemateriaal/adr/0002-prioriteitsketen-catalogus-drielagen-fundament.md) |  |
...
| F2.3 | Regelsets los van items, met min/max-keuzeregels | Beheerders wijzigen regelsets los van catalogusitems; het systeem bewaakt automatisch minimum- en maximumkeuzes. | [PR 120, R2 en R5 (in review)](https://github.com/Npuls-OKx/meta/pull/120) |  |
...
| F4.2 | Keuze gescheiden van inschrijving en resultaat | Studentinformatiesysteem en studentkeuzesysteem verwerken wijzigingen in inschrijving en keuze onafhankelijk van elkaar. | [ADR 0009](https://github.com/Npuls-OKx/Public/blob/dev/Referentiemateriaal/adr/0009-sks-svs-rollenverdeling-keuze-vs-resultaat-voortgang.md) |  |
...
| F6.3 | N:M-cardinaliteit en prerequisite-relaties | Systemen leggen relaties tussen leeruitkomsten, onderdelen en voorwaarden (prerequisites) eenduidig vast, ook waar één leeruitkomst meerdere onderdelen raakt. | [Consumer-profiel §3.2.6](../specificatie/okx-oeapi-consumer-profiel/doc/20260501_Specificatie_document_OKx_OEAPI_profiel.md#326-het-vlaks-model-als-ankertabel--6-niveaus--6-families) |  |
