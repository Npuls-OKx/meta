...
| F5.4 | Toetsing zodra leeruitkomsten gedekt zijn | De student kan toetsen zodra de leeruitkomsten gedekt zijn, ook zonder elke leergelegenheid te hebben bijgewoond. | [Scenario-uitwerkingen §3.4.9](../specificatie/leerroute-uitwerking/doc/scenario-uitwerkingen.md#349-scenario-31--versnellen-by-design-anker-lr3) |  |
