...
| S3.4 | Als roosteraar wil ik geroosterd aanbod per periode publiceren en beschikbaar stellen aan student en docent, zodat latere perioden planbaar blijven. | F3.1 Drie stadia van onderwijsaanbod | [Scenario-uitwerkingen §3.4.1](../specificatie/leerroute-uitwerking/doc/scenario-uitwerkingen.md#341-scenario-11--regulier-happyflow) | geen |
| S3.5 | Als student wil ik voor de start van het onderwijs toegang tot het leermanagementsysteem en mijn periode-rooster krijgen, zodat ik op de eerste lesdag kan beginnen. | F3.1 Drie stadia van onderwijsaanbod | [Scenario-uitwerkingen §3.4.1](../specificatie/leerroute-uitwerking/doc/scenario-uitwerkingen.md#341-scenario-11--regulier-happyflow) | geen |
...
| Id | Story | Feature | Bron | Koppeling |
|---|---|---|---|---|
| S5.1 | Als docent wil ik tijdens de uitvoering per les de verbintenistoestand (Association.state) van studenten muteren en resultaten vastleggen, zodat voortgang en resultaat herleidbaar zijn. | F5.1 Resultaatstructuur inrichten en resultaten registreren | [Scenario-uitwerkingen §3.4.1](../specificatie/leerroute-uitwerking/doc/scenario-uitwerkingen.md#341-scenario-11--regulier-happyflow) | geen |
