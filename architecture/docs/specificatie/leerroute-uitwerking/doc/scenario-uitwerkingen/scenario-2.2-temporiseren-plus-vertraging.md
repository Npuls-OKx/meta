# Scenario 2.2: temporiseren by design plus vertraging by accident

**Doel.** Toetsen hoe twee tempo-afwijkingen (één ontworpen, één incidenteel) gecombineerd zichtbaar blijven zonder dubbele track-administratie.

**Scope.** Leerroute 2 met extra vertraging by accident; delta ten opzichte van [scenario 2.1](scenario-2.1-temporiseren-by-design.md). Status: pitch, nog uit te werken. Het sjabloon, de casus en de samenhang staan in de [README](README.md). Relateert aan: #137.
