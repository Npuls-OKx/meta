...
**Scope.** Leerroute 3 (versnellen by design), zonder vrijstellingen (die volgen bij leerroute 4 tot en met 9); delta ten opzichte van [scenario 1.1](scenario-1.1-regulier-happyflow.md). Status: pitch, nog uit te werken. Het sjabloon, de casus en de samenhang staan in de [README](README.md).
