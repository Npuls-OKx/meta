# Scenario 3.1: versnellen by design (anker leerroute 3)

**Doel.** De baseline voor leerroute 3 vastleggen: dezelfde opleiding bewust in kortere tijd met hogere intensiteit, inclusief toetsen zodra de leeruitkomsten gedekt zijn.

**Scope.** Leerroute 3 (versnellen by design), zonder vrijstellingen (die volgen bij leerroute 4 tot en met 9); delta ten opzichte van [scenario 1.1](scenario-1.1-regulier-happyflow.md). Status: pitch, nog uit te werken. Het sjabloon, de casus en de samenhang staan in de [README](README.md). Relateert aan: #137.
