...
Context: OC naar P&R (onderwijscatalogus naar planning en roostering), intra-instelling eerst. Scenario: [LeerRoute 1 ([LR1](../leerroute-uitwerking/doc/persona_jochem.md "persona Jochem, leerroute 1"))](../leerroute-uitwerking/doc/leerroute-uitwerking-lr1.md "leerroutes en persona's in het OEAPI-profiel"); de eisen gelden generiek voor **alle keuzes rond onderwijsspecificaties**, keuzedelen zijn het eerste geval. Niveau: requirements (semantisch, nog geen OEAPI-attributen). Status: concept. Relateert aan: #84.
...
2. [Doel](#2-doel)
3. [Scope](#3-scope)
4. [Scenario ([LR1](../leerroute-uitwerking/doc/persona_jochem.md "persona Jochem, leerroute 1"))](#4-scenario-lr1)
...
OKx gaat uit van toenemende flexibilisering: uiteindelijk wordt bijna elk onderdeel keuzedeel en stelt elke student een eigen opleiding samen. Dan is het beperken en relateren van keuzes wat de keten beheersbaar houdt. Binnen [LR1-3](../leerroute-uitwerking/doc/leerroute-uitwerking-lr1.md "leerroutes en persona's in het OEAPI-profiel") is de keuzeruimte nog klein.
...
- Leerroutes: [LR1](../leerroute-uitwerking/doc/persona_jochem.md "persona Jochem, leerroute 1") uitgewerkt. [LR2](../leerroute-uitwerking/doc/persona_larissa.md "persona Larissa, leerroute 2") en [LR3](../leerroute-uitwerking/doc/persona_linda.md "persona Linda, leerroute 3") nog niet af, volgen als verschil (delta) ten opzichte van [LR1](../leerroute-uitwerking/doc/persona_jochem.md "persona Jochem, leerroute 1").
...
## 4. Scenario ([LR1](../leerroute-uitwerking/doc/persona_jochem.md "persona Jochem, leerroute 1"))

Jochem volgt regulier Apothekersassistent ([LR1](../leerroute-uitwerking/doc/persona_jochem.md "persona Jochem, leerroute 1")) en mag een keuzedeel kiezen. Twee soorten, met een verschillend regelprofiel:
...
Elke eis met een concreet voorbeeld uit [LR1-3](../leerroute-uitwerking/doc/leerroute-uitwerking-lr1.md "leerroutes en persona's in het OEAPI-profiel"), en elk voorbeeld is als figuur uitgewerkt in §7 (dekkingstabel in §7.5). "MOET" in de zin van RFC 2119 (MUST).
...
- **R5 Ruimte voor vrijere keuzevormen later.** De regels sluiten vrijere vormen niet uit. Voorbeeld: later moet "kies 2 van 5 keuzedelen" mogelijk zijn zonder de [LR1-3](../leerroute-uitwerking/doc/leerroute-uitwerking-lr1.md "leerroutes en persona's in het OEAPI-profiel")-afspraken te breken. Figuur 7.4.1.
...
- **R17 Herleidbare regelversie.** Regelsets kennen eigen versionering, en achteraf is vaststelbaar welke regelversie gold bij een keuze. Voorbeeld: voor [Jochems](../leerroute-uitwerking/doc/persona_jochem.md "persona Jochem, leerroute 1") cohort 2026 gold regelset-versie 1.2; dat blijft herleidbaar voor de diplomaverantwoording, ook wanneer latere cohorten versie 2.0 volgen. Figuur 7.4.7.
...
### 7.2 Onderwijsspecificatiestructuur [LR1](../leerroute-uitwerking/doc/persona_jochem.md "persona Jochem, leerroute 1") met keuzedelen en voorwaarde vooraf
...
5. [LR2](../leerroute-uitwerking/doc/persona_larissa.md "persona Larissa, leerroute 2") en [LR3](../leerroute-uitwerking/doc/persona_linda.md "persona Linda, leerroute 3") als delta ten opzichte van [LR1](../leerroute-uitwerking/doc/persona_jochem.md "persona Jochem, leerroute 1").
