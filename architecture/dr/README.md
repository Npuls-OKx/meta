...
| 0021 | [`0021-koppeling-versus-koppelvlak-terminologie.md`](0021-koppeling-versus-koppelvlak-terminologie.md) | Koppeling (informatiestroom tussen 2 componenten) vs koppelvlak (alle koppelingen van 1 component); mapindeling, centrale payload met gebruiksprofielen *(concept)* |
| 0022 | [`0022-resultaatbegrippen-conform-rosa-koi.md`](0022-resultaatbegrippen-conform-rosa-koi.md) | Onderwijsresultaat op leeruitkomsten (ROSA KOI); toetsonderdeelresultaten gewogen naar onderwijsresultaat; verbintenis op aanbod; nominaal template + individuele structuur *(concept)* |
| 0023 | [`0023-leeruitkomsten-als-opaque-sleutels-in-koppeling-oc-p-en-r.md`](0023-leeruitkomsten-als-opaque-sleutels-in-koppeling-oc-p-en-r.md) | Leeruitkomst-ids als opaque sleutels binnen OC-P&R (alleen volgordebepaling); betekenis bij OC-SIS en OC-LMS *(concept)* |
