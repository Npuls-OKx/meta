...
| 0021 | [`0021-koppeling-versus-koppelvlak-terminologie.md`](0021-koppeling-versus-koppelvlak-terminologie.md) | Koppeling (informatiestroom tussen 2 componenten) vs koppelvlak (alle koppelingen van 1 component); mapindeling en duplicatie payloads *(concept)* |
