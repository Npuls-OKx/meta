...
- `python3 scripts/teken-hoofdplaat-highlight.py --plaat PAD` schrijft `informatiemodel/img/hoofdplaat/f<N>.svg`: per fase de hoofdplaat met de stromen van het voorbeeld gemarkeerd. De render van de plaat komt uit `exporteer-archimate-platen.py`; het script meldt stromen die het niet kon plaatsen.
