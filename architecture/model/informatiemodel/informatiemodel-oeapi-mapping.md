...
**Bron.** De mappings in dit document komen uit het ArchiMate-model, uit de view `OKx informatiemodel en mapping OEAPI`. Er is niets van de plaat overgetypt.
...
26 van de 62 objecttypen hebben geen OEAPI-tegenhanger op deze plaat. Dat zijn twee groepen: het kwalificatiekader met de onderwijskundige begrippen, en de hele resultaatstructuur.
