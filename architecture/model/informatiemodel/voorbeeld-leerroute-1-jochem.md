...
| R5-012 | Studiebeeld volgen in het studentvolgsysteem | ontstaat | Leergelegenheid resultaat | B1-K1-W1 afgerond, periode 1 | [f5-33-studiebeeld-volgen-in-het-studentvolgsysteem.svg](img/regels/f5-33-studiebeeld-volgen-in-het-studentvolgsysteem.svg) | [leerroute-1-regulier.md](https://github.com/Npuls-OKx/Public/blob/dev/Referentiemateriaal/kaderscenario's/leerroute-1-regulier.md), [Fase 5](https://github.com/Npuls-OKx/Public/blob/dev/Referentiemateriaal/kaderscenario's/leerroute-1-regulier.md#fase-5--onderwijs-uitvoeren-en-voortgang-begeleiden): SLB'ers volgen Jochems studiebeeld in SVS |
