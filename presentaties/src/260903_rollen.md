...
<div style="display: flex; flex-direction: column; align-items: center; gap: 0.3rem; margin-top: 1.6rem;">
  ...
  <div style="display: flex; align-items: center; gap: 1.2rem; width: 84%; background: #f1ecfa; border-left: 8px solid #7a5dba; border-radius: 4px; padding: 1.3rem 1.4rem;">
    ...
    <div style="font-size: 1.15rem; line-height: 1.6;">Wanneer ga ik te ver?<br/>Wat zijn de rollen en verantwoordelijkheden binnen OKx?</div>
  </div>
