...
flowchart TB
  ...
  subgraph T["Tactisch"]
    ...
    subgraph TB2["Team business"]
      direction LR
      PO1["Product owner °"] ~~~ BA["Business analist"]
    end
  ...
  subgraph O["Operationeel"]
    direction LR
    TL2["Tech lead °"] ~~~ PO2["Product owner °"] ~~~ LD["Lead developer"] ~~~ DEV["Developer"] ~~~ TE["Test engineer"] ~~~ RM["Release manager"]
  end
  S --> T
  T --> O
  EX -.-> T
...
Normaal worden deze rollen door verschillende mensen ingevuld. De ring markeert een rol die op twee niveaus voorkomt: lead architect, tech lead en product owner.
</div>
...
| Team business | Business analist | Behoeften uitwerken tot toetsbare eisen |
