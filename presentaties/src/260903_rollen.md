...
flowchart TB
  ...
  T ==> O
  EX ==>|advies| T
  style EX fill:#f2eff4,stroke:#8c7e94
  style S fill:#e9edf2,stroke:#7d8a99
  style T fill:#f2efe7,stroke:#9a9280
  style O fill:#e8f0ec,stroke:#7f9a8c
```
...
flowchart TB
  ...
  EX ==>|advies| T
  style EX fill:#f2eff4,stroke:#8c7e94
  style S fill:#cfe0e8,stroke:#0B4F6C,stroke-width:2px
  style T fill:#cfe0e8,stroke:#0B4F6C,stroke-width:2px
  style O fill:#e8f0ec,stroke:#7f9a8c
...
<div class="np-grid-2" style="margin-top: 0.4rem; gap: 1.2rem; font-size: 0.82rem; line-height: 1.5;">
<div>
...
Dat komt door wat leveranciers en de architectuurboard van ons vragen: **publiek en vindbaar**, **versioneerbaar per koppeling**, **herleidbaar** naar wie een wijziging maakte en waarom, **per regel reviewbaar**, **machinaal controleerbaar**, **onafhankelijk toetsbaar** en **beheerbaar na het project**.
...
<div class="np-grid-2" style="margin-top: 0.8rem; gap: 1.1rem; font-size: 0.8rem; line-height: 1.45;">
<div>
...
| Integratie en standaardisatie | Begrippenkader en OEAPI-mapping |
