...
<div style="flex:1; background:#d9f5ec; border-radius:10px; padding:0.9rem 1rem; display:flex; flex-direction:column;"><div style="font-size:0.95rem; font-weight:700; color:#0E9E7E; margin-bottom:0.35rem;">Eenduidig vastgelegd</div><div style="font-size:0.9rem; line-height:1.4;">Elk systeem bedoelt hetzelfde.</div><div style="margin-top:0.75rem; padding-top:0.6rem; border-top:1px solid #0E9E7E33;"><div><div style="display:flex; gap:0.3rem;"><div style="flex:1; background:#fff; border:2px solid #0E9E7E; border-radius:5px; padding:0.15rem 0; text-align:center; font-size:0.62rem; font-weight:700; color:#0E9E7E;">OC</div><div style="flex:1; background:#fff; border:2px solid #0E9E7E; border-radius:5px; padding:0.15rem 0; text-align:center; font-size:0.62rem; font-weight:700; color:#0E9E7E;">SIS</div><div style="flex:1; background:#fff; border:2px solid #0E9E7E; border-radius:5px; padding:0.15rem 0; text-align:center; font-size:0.62rem; font-weight:700; color:#0E9E7E;">LMS</div></div><svg viewBox="0 0 200 22" preserveAspectRatio="none" style="width:100%; height:1.1rem;"><path d="M33 0 V8 H100 V22" fill="none" stroke="#0E9E7E" stroke-width="2"/><path d="M100 0 V22" fill="none" stroke="#0E9E7E" stroke-width="2"/><path d="M167 0 V8 H100 V22" fill="none" stroke="#0E9E7E" stroke-width="2"/></svg><div style="background:#0E9E7E; color:#fff; border-radius:5px; padding:0.15rem 0; text-align:center; font-size:0.68rem; font-weight:700;">dezelfde betekenis</div></div></div></div><div style="flex:1; background:#dceffa; border-radius:10px; padding:0.9rem 1rem; display:flex; flex-direction:column;"><div style="font-size:0.95rem; font-weight:700; color:#2E86C1; margin-bottom:0.35rem;">Machine-interpreteerbaar</div><div style="font-size:0.9rem; line-height:1.4;">Een agent leest de specificatie zonder te gokken.</div><div style="margin-top:0.75rem; padding-top:0.6rem; border-top:1px solid #2E86C133;"><div style="display:flex; align-items:center; justify-content:center; gap:0.45rem;"><svg viewBox="0 0 52 60" style="width:2.1rem; height:2.4rem;"><rect x="6" y="4" width="40" height="52" rx="3" fill="#fff" stroke="#5b6670" stroke-width="2"/><rect x="12" y="12" width="28" height="4" rx="2" fill="#2E86C1"/><line x1="12" y1="26" x2="40" y2="26" stroke="#94a3b0" stroke-width="2"/><line x1="12" y1="34" x2="40" y2="34" stroke="#94a3b0" stroke-width="2"/><line x1="12" y1="42" x2="32" y2="42" stroke="#94a3b0" stroke-width="2"/></svg><span style="font-family:monospace; font-size:1rem; font-weight:700; color:#2E86C1;">&#123;&nbsp;&#125;</span><span style="font-size:1rem; color:#2E86C1;">&#9654;</span><svg viewBox="0 0 40 52" style="width:1.7rem; height:2.2rem;"><line x1="20" y1="4" x2="20" y2="12" stroke="#5b6670" stroke-width="2"/><circle cx="20" cy="4" r="3" fill="#5b6670"/><rect x="6" y="12" width="28" height="22" rx="5" fill="#fff" stroke="#5b6670" stroke-width="2"/><circle cx="15" cy="23" r="3" fill="#5b6670"/><circle cx="25" cy="23" r="3" fill="#5b6670"/><rect x="10" y="38" width="20" height="10" rx="2" fill="#fff" stroke="#5b6670" stroke-width="2"/></svg></div></div></div><div style="flex:1; background:#ffeed9; border-radius:10px; padding:0.9rem 1rem; display:flex; flex-direction:column;"><div style="font-size:0.95rem; font-weight:700; color:#E8912B; margin-bottom:0.35rem;">We doen het zelf al</div><div style="font-size:0.9rem; line-height:1.4;">Deze specificatie wordt met AI gebouwd en versioneerd.</div><div style="margin-top:0.75rem; padding-top:0.6rem; border-top:1px solid #E8912B33;"><div style="display:flex; align-items:center; justify-content:center; gap:0.28rem; flex-wrap:wrap;"><span style="background:#E8912B; color:#fff; border-radius:999px; padding:0.1rem 0.45rem; font-size:0.62rem; font-weight:700;">AI</span><span style="color:#E8912B; font-size:0.75rem;">&#9654;</span><span style="background:#fff; border:1px solid #E8912B; color:#8a5a12; border-radius:999px; padding:0.1rem 0.4rem; font-size:0.62rem; font-weight:700;">bouwen</span><span style="color:#E8912B; font-size:0.75rem;">&#9654;</span><span style="background:#fff; border:1px solid #E8912B; color:#8a5a12; border-radius:999px; padding:0.1rem 0.4rem; font-size:0.62rem; font-weight:700;">reviewen</span><span style="color:#E8912B; font-size:0.75rem;">&#9654;</span><span style="background:#fff; border:1px solid #E8912B; color:#8a5a12; border-radius:999px; padding:0.1rem 0.4rem; font-size:0.62rem; font-weight:700;">versioneren</span></div></div></div>
</div>

<div class="np-card" style="border-top-color: #0E9E7E; font-size: 1rem; line-height: 1.55; margin-top: 1rem; max-width: 96%;">
Leg de betekenis eenduidig vast en maak haar leesbaar voor een machine. <strong style="color:#0E9E7E;">Dan kan het bouwen straks heel snel, en zetten we AI in waar die sterk is.</strong>
</div>

</div>

<!--
Drie pijlers, elk met een beeld. De middelste is bewust de tegenhanger van de
risicoslide hierna: daar staan een mens en een robot met een vraagteken bij
dezelfde specificatie, hier leest de agent hem zonder te gokken. Wat dit vraagt
staat niet meer op deze slide maar op de laatste, zodat de vraag een keer wordt
gesteld en niet twee keer.
-->
