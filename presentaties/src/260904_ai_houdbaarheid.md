...
<div class="np-card" style="border-top-color: #A8481F; font-size: 0.95rem; line-height: 1.5; margin-top: 0.7rem; max-width: 96%;">
<strong style="color:#A8481F;">AI haalt de afspraak niet weg, AI maakt het ombouwen ernaartoe goedkoop.</strong> Dat werkt alleen als de specificatie machine-interpreteerbaar is. Wat AI niet overneemt: wie bron is, wat een leeruitkomst betekent, en wanneer een resultaat rechtsgeldig is.
</div>
...
overgaat. Een diploma blijft een rechtsfeit: dat vraagt vastlegging, geen kansverdeling. Daarom telt machine-interpreteerbaar, en daarom telt borging.
-->
