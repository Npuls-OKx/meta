...
<div class="np-card" style="border-top-color: #A8481F; font-size: 0.92rem; line-height: 1.45; margin-top: 0.6rem; max-width: 96%;"><strong style="color:#A8481F;">Wat AI niet overneemt</strong>: wie bron is, wat een leeruitkomst betekent, en wanneer een resultaat rechtsgeldig is.</div>

<div v-click style="margin-top:0.55rem; max-width:96%; background:#0B4F6C; color:#fff; border-radius:10px; padding:0.9rem 1.3rem;"><div style="font-size:1.4rem; font-weight:700; line-height:1.2; color:#fff;">OKx is die afspraak. AI rijdt erover, maar legt hem niet.</div><div style="font-size:0.92rem; line-height:1.45; margin-top:0.4rem; opacity:0.9;">Een afspraak tussen instellingen vraagt een mandaat. Daar moet iemand aan gehouden kunnen worden.</div></div>
