...
<div style="display:flex;align-items:center;gap:0.9rem;margin-top:0.45rem;"><svg width="40" height="40" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#E9A27F"/><polyline points="12,23 19,30 32,15" fill="none" stroke="#fff" stroke-width="3.5" stroke-linecap="round" stroke-linejoin="round"/></svg><dl class="np-besluit " style="flex:1;"><dt>Afspraak</dt><dd>elke koppelingspecificatie krijgt een korte, stabiele ID naast de naam, zoals OC-PR; beide richtingen van een koppeling in één specificatie (<a href="https://github.com/Npuls-OKx/Public/issues/107">Public #107</a>)</dd></dl></div>
...
(13:51). Koppeling-ID: vraag van Kees (01:06), kernteam akkoord; beide richtingen in één
specificatie (01:08). Nabranders: Jan Hendrik vindt het nog veel over de vorm; Kees ziet goede stappen op koppelvlak,
