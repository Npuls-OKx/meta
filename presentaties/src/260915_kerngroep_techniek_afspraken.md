---
theme: default
title: "Kerngroep techniek, 15 september 2026, met afspraken"
...
<div style="position: absolute; inset: 0; display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; padding: 2rem 4rem; z-index: 1;">
  ...
  <div style="font-size: 0.9rem; color: var(--np-orange); margin-top: 0.9rem; font-weight: 600;">Nagestuurd na de sessie: de gemarkeerde kaarten en de slotslides bevatten de afspraken</div>
</div>
...
<div class="np-card accent-orange" style="margin-top:0.8rem;font-size:0.9rem;padding:0.5rem 0.9rem;"><strong>Afgesproken op 15 september:</strong> Public PR 82 en PR 100 gaan naar draft en vragen nu geen review; Public PR 104 blijft open voor review. Het signaal over de tijdsbesteding gaat naar Ruud en Hans.</div>
...
<div class="np-card accent-orange" style="margin-top: 0.6rem; font-size: 0.95rem; line-height: 1.5; padding: 0.6rem 1rem;">
<strong>Reactie 15 september:</strong> intekenen op een specificatie is nieuw en wordt door de leveranciers niet herkend; AII hanteert de volgorde aanmelden, intekenen, inschrijven. Geparkeerd; komt terug met de voorbeelduitwerking.
</div>
...
<div class="np-card accent-orange" style="margin-top: 0.7rem; font-size: 0.93rem; line-height: 1.45; padding: 0.55rem 1rem;">
<strong>Reactie 15 september:</strong> zolang intekenen op een specificatie niet wordt herkend, is ook het verzoek tot aanbod als objecttype niet vastgesteld. Geparkeerd; de vraag komt terug met de voorbeelduitwerking.
</div>
...
# Prioritering, zoals afgesproken
...
<strong>Nu</strong>
<div style="display:flex;align-items:center;gap:0.7rem;margin-top:0.55rem;font-size:0.95rem;line-height:1.35;"><svg width="44" height="44" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#7CCBA8"/><polygon points="17,12 34,22 17,32" fill="#fff"/></svg><div>Voorbeelduitwerking van het informatiemodel: de opleiding van Jochem uit leerroute 1 uitgedrukt in het model, van abstract naar implementatie (vraag van Kees)</div></div>
<div style="display:flex;align-items:center;gap:0.7rem;margin-top:0.55rem;font-size:0.95rem;line-height:1.35;"><svg width="44" height="44" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#7CCBA8"/><polygon points="17,12 34,22 17,32" fill="#fff"/></svg><div>Versionering: Garik maakt een voorbeeld van een flow, liefst op een associatie-endpoint, en plant een sessie om het samen door te nemen</div></div>
<div style="display:flex;align-items:center;gap:0.7rem;margin-top:0.55rem;font-size:0.95rem;line-height:1.35;"><svg width="44" height="44" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#7CCBA8"/><polygon points="17,12 34,22 17,32" fill="#fff"/></svg><div>Review op <a href="https://github.com/Npuls-OKx/Public/pull/104">Public PR 104</a>: het informatiemodel en de begrippen naast het eigen model leggen; opmerkingen in de PR</div></div>
<div style="display:flex;align-items:center;gap:0.7rem;margin-top:0.55rem;font-size:0.95rem;line-height:1.35;"><svg width="44" height="44" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#7CCBA8"/><polygon points="17,12 34,22 17,32" fill="#fff"/></svg><div>Stories opnieuw ophalen bij de PoC-scholen en de business-architectuur uitwerken, via Niels</div></div>
</div>
<div class="np-card" style="border-top-color: #B8BEC7; background: #F6F7F9;">
<strong>Wacht</strong>
<div style="display:flex;align-items:center;gap:0.7rem;margin-top:0.55rem;font-size:0.95rem;line-height:1.35;"><svg width="44" height="44" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#B8BEC7"/><rect x="15" y="12" width="5" height="20" rx="1" fill="#fff"/><rect x="24" y="12" width="5" height="20" rx="1" fill="#fff"/></svg><div>Student keuze regelsets: alleen als er ruimte overblijft</div></div>
<div style="display:flex;align-items:center;gap:0.7rem;margin-top:0.55rem;font-size:0.95rem;line-height:1.35;"><svg width="44" height="44" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#B8BEC7"/><rect x="15" y="12" width="5" height="20" rx="1" fill="#fff"/><rect x="24" y="12" width="5" height="20" rx="1" fill="#fff"/></svg><div>Review op <a href="https://github.com/Npuls-OKx/Public/pull/82">Public PR 82</a> en <a href="https://github.com/Npuls-OKx/Public/pull/100">Public PR 100</a>: beide naar draft</div></div>
<div style="display:flex;align-items:center;gap:0.7rem;margin-top:0.55rem;font-size:0.95rem;line-height:1.35;"><svg width="44" height="44" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#B8BEC7"/><rect x="15" y="12" width="5" height="20" rx="1" fill="#fff"/><rect x="24" y="12" width="5" height="20" rx="1" fill="#fff"/></svg><div>Meerdere instanties van een referentiecomponent (<a href="https://github.com/Npuls-OKx/meta/issues/80">meta #80</a>)</div></div>
...
Afgesproken op 15 september; het voorstel van het kernteam is aangepast op de vraag om eerst een voorbeeld en op de status van de pull requests.
</div>

</div>

<!--
De voorbeelduitwerking is de vraag van Kees (01:34 in de opname): een opleiding helemaal
uitdrukken in het informatiemodel, zodat duidelijk wordt of iedereen het over hetzelfde heeft;
Huib Jan: verduidelijkende voorbeelden zijn altijd welkom. De keuzeregelsets schuiven daardoor
naar "als er ruimte is". Garik maakt het versioneringsvoorbeeld (Huib Jan en Kees vroegen er
om) en plant een sessie; tot dan blijft PR 100 draft. PR 82 gaat naar draft omdat de
requirementsboom nog in beweging is; de stories worden bij de PoC-scholen opnieuw opgehaald.
-->
---
...
# Afspraken 15 september

<div style="display:flex;align-items:center;gap:0.9rem;margin-top:0.6rem;"><svg width="40" height="40" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#B8BEC7"/><rect x="13" y="11" width="18" height="22" rx="2" fill="#fff"/><line x1="17" y1="18" x2="27" y2="18" stroke="#B8BEC7" stroke-width="2"/><line x1="17" y1="23" x2="27" y2="23" stroke="#B8BEC7" stroke-width="2"/><line x1="17" y1="28" x2="23" y2="28" stroke="#B8BEC7" stroke-width="2"/></svg><dl class="np-besluit kennisname" style="flex:1;"><dt>Draft</dt><dd><a href="https://github.com/Npuls-OKx/Public/pull/82">Public PR 82</a> (v0.0.2, requirementsboom) en <a href="https://github.com/Npuls-OKx/Public/pull/100">Public PR 100</a> (modulariteit en versionering): geen review nu. Een draft-PR mag de kerngroep negeren</dd></dl></div>
<div style="display:flex;align-items:center;gap:0.9rem;margin-top:0.6rem;"><svg width="40" height="40" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#7A97F2"/><circle cx="19" cy="19" r="8" fill="none" stroke="#fff" stroke-width="3"/><line x1="25" y1="25" x2="33" y2="33" stroke="#fff" stroke-width="3" stroke-linecap="round"/></svg><dl class="np-besluit review" style="flex:1;"><dt>Review</dt><dd><a href="https://github.com/Npuls-OKx/Public/pull/104">Public PR 104</a>: het informatiemodel en de begrippen; opmerkingen in de pull request</dd></dl></div>
<div style="display:flex;align-items:center;gap:0.9rem;margin-top:0.6rem;"><svg width="40" height="40" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#E9A27F"/><polyline points="12,23 19,30 32,15" fill="none" stroke="#fff" stroke-width="3.5" stroke-linecap="round" stroke-linejoin="round"/></svg><dl class="np-besluit " style="flex:1;"><dt>Besluit</dt><dd>prioritering: eerst de voorbeelduitwerking van het informatiemodel, Gariks versioneringsvoorbeeld met een sessie, en de stories opnieuw via de PoC-scholen; keuzeregelsets als er ruimte is</dd></dl></div>
<div style="display:flex;align-items:center;gap:0.9rem;margin-top:0.6rem;"><svg width="40" height="40" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#7A97F2"/><path d="M11 13 h22 a3 3 0 0 1 3 3 v11 a3 3 0 0 1 -3 3 h-12 l-6 5 v-5 h-4 a3 3 0 0 1 -3 -3 v-11 a3 3 0 0 1 3 -3 z" fill="#fff"/></svg><dl class="np-besluit kennisname" style="flex:1;"><dt>Naar Ruud en Hans</dt><dd>wat betekent ja zeggen op een pull request of story voor een leverancier (governance op papier), en de tijdsbesteding die ver boven de afspraak ligt</dd></dl></div>
<div style="display:flex;align-items:center;gap:0.9rem;margin-top:0.6rem;"><svg width="40" height="40" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#7A97F2"/><path d="M11 13 h22 a3 3 0 0 1 3 3 v11 a3 3 0 0 1 -3 3 h-12 l-6 5 v-5 h-4 a3 3 0 0 1 -3 -3 v-11 a3 3 0 0 1 3 -3 z" fill="#fff"/></svg><dl class="np-besluit kennisname" style="flex:1;"><dt>Geparkeerd</dt><dd>intekenen op specificatie en het verzoek tot aanbod; de namen berichtstroom en applicatiedienst en een naam per koppelingspecificatie; welk interactiepatroon wanneer, met het onderscheid tussen informeren en een transactie</dd></dl></div>

</div>

<!--
Uit de opname van 15 september. Draft: Kees vroeg om PR's die geen review vragen op draft te
zetten, Garik en Niek akkoord (01:44). PR 104 blijft open (01:45). Prioritering: 01:43 tot
01:44. Governance: Jan Hendrik (38:55, 40:12) en Kees (53:17); tijdsbesteding: Huib Jan
(13:51). Geparkeerd: intekenen (01:42), terminologie (45:25, 01:06), patronen (56:31 tot 01:01).
Nabranders: Jan Hendrik vindt het nog veel over de vorm; Kees ziet goede stappen op koppelvlak,
koppeling en endpoints en is blij met het datamodel.
-->
---
...
<div style="margin-top: 0.6rem;"><div style="display:flex;align-items:center;gap:0.8rem;margin-top:0.6rem;font-size:0.95rem;line-height:1.4;"><svg width="36" height="36" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#7CCBA8"/><polygon points="17,12 34,22 17,32" fill="#fff"/></svg><div><strong>Garik:</strong> iteratie op de versionering met een voorbeeldflow, en een sessie vooraf om die samen door te nemen</div></div><div style="display:flex;align-items:center;gap:0.8rem;margin-top:0.6rem;font-size:0.95rem;line-height:1.4;"><svg width="36" height="36" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#7CCBA8"/><polygon points="17,12 34,22 17,32" fill="#fff"/></svg><div><strong>Niek:</strong> voorbeelduitwerking van het informatiemodel langs leerroute 1; eventueel de student keuze regelsets</div></div><div style="display:flex;align-items:center;gap:0.8rem;margin-top:0.6rem;font-size:0.95rem;line-height:1.4;"><svg width="36" height="36" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#7CCBA8"/><polygon points="17,12 34,22 17,32" fill="#fff"/></svg><div><strong>Niels:</strong> requirements en business-architectuur, met de eerste PoC-sessies bij de scholen</div></div><div style="display:flex;align-items:center;gap:0.8rem;margin-top:0.6rem;font-size:0.95rem;line-height:1.4;"><svg width="36" height="36" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#7A97F2"/><circle cx="19" cy="19" r="8" fill="none" stroke="#fff" stroke-width="3"/><line x1="25" y1="25" x2="33" y2="33" stroke="#fff" stroke-width="3" stroke-linecap="round"/></svg><div><strong>Kerngroep:</strong> <a href="https://github.com/Npuls-OKx/Public/pull/104">Public PR 104</a> bekijken en opmerkingen achterlaten</div></div><div style="display:flex;align-items:center;gap:0.8rem;margin-top:0.6rem;font-size:0.95rem;line-height:1.4;"><svg width="36" height="36" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#7A97F2"/><circle cx="19" cy="19" r="8" fill="none" stroke="#fff" stroke-width="3"/><line x1="25" y1="25" x2="33" y2="33" stroke="#fff" stroke-width="3" stroke-linecap="round"/></svg><div><strong>Ruud en Hans:</strong> governance op papier: wat betekent een ja van een leverancier</div></div></div>
