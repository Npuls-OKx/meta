...
<div style="display:flex;align-items:center;gap:0.9rem;margin-top:0.6rem;"><svg width="40" height="40" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#E9A27F"/><polyline points="12,23 19,30 32,15" fill="none" stroke="#fff" stroke-width="3.5" stroke-linecap="round" stroke-linejoin="round"/></svg><dl class="np-besluit " style="flex:1;"><dt>Besluit</dt><dd>prioritering: eerst de voorbeelduitwerking van het informatiemodel, Gariks versioneringsvoorbeeld met een sessie; Niels haalt de stories opnieuw op bij de PoC-scholen en ontwikkelt de business-architectuur door; keuzeregelsets als er ruimte is</dd></dl></div>
<div style="display:flex;align-items:center;gap:0.9rem;margin-top:0.6rem;"><svg width="40" height="40" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#7A97F2"/><path d="M11 13 h22 a3 3 0 0 1 3 3 v11 a3 3 0 0 1 -3 3 h-12 l-6 5 v-5 h-4 a3 3 0 0 1 -3 -3 v-11 a3 3 0 0 1 3 -3 z" fill="#fff"/></svg><dl class="np-besluit kennisname" style="flex:1;"><dt>Naar Ruud en Hans</dt><dd>een aanpak formuleren op de vraag: wanneer zijn leveranciers het eens met ons verhaal, en welke rol spelen stories en pull requests daarin? Daarnaast de tijdsbesteding, die ver boven de afspraak ligt</dd></dl></div>
...
(13:51). Nabranders: Jan Hendrik vindt het nog veel over de vorm; Kees ziet goede stappen op koppelvlak,
