...
<div style="display:flex;align-items:center;gap:0.7rem;margin-top:0.55rem;font-size:0.95rem;line-height:1.35;"><svg width="44" height="44" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#7CCBA8"/><polygon points="17,12 34,22 17,32" fill="#fff"/></svg><div>Niels haalt de stories opnieuw op bij de PoC-scholen en ontwikkelt de business-architectuur door</div></div>
</div>
...
<div class="fill" style="font-size:0.92rem;">

# Afspraken 15 september

<div style="display:flex;align-items:center;gap:0.9rem;margin-top:0.45rem;"><svg width="40" height="40" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#B8BEC7"/><rect x="13" y="11" width="18" height="22" rx="2" fill="#fff"/><line x1="17" y1="18" x2="27" y2="18" stroke="#B8BEC7" stroke-width="2"/><line x1="17" y1="23" x2="27" y2="23" stroke="#B8BEC7" stroke-width="2"/><line x1="17" y1="28" x2="23" y2="28" stroke="#B8BEC7" stroke-width="2"/></svg><dl class="np-besluit kennisname" style="flex:1;"><dt>Draft</dt><dd><a href="https://github.com/Npuls-OKx/Public/pull/82">Public PR 82</a> (v0.0.2) en <a href="https://github.com/Npuls-OKx/Public/pull/100">Public PR 100</a> (modulariteit en versionering): geen review nu; een draft-PR mag de kerngroep negeren</dd></dl></div>
<div style="display:flex;align-items:center;gap:0.9rem;margin-top:0.45rem;"><svg width="40" height="40" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#7A97F2"/><circle cx="19" cy="19" r="8" fill="none" stroke="#fff" stroke-width="3"/><line x1="25" y1="25" x2="33" y2="33" stroke="#fff" stroke-width="3" stroke-linecap="round"/></svg><dl class="np-besluit review" style="flex:1;"><dt>Review</dt><dd><a href="https://github.com/Npuls-OKx/Public/pull/104">Public PR 104</a>: het informatiemodel en de begrippen; opmerkingen in de pull request</dd></dl></div>
<div style="display:flex;align-items:center;gap:0.9rem;margin-top:0.45rem;"><svg width="40" height="40" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#E9A27F"/><polyline points="12,23 19,30 32,15" fill="none" stroke="#fff" stroke-width="3.5" stroke-linecap="round" stroke-linejoin="round"/></svg><dl class="np-besluit " style="flex:1;"><dt>Besluit</dt><dd>prioritering: eerst de voorbeelduitwerking van het informatiemodel en Gariks versioneringsvoorbeeld met een sessie; Niels haalt de stories op bij de PoC-scholen en ontwikkelt de business-architectuur door; keuzeregelsets als er ruimte is</dd></dl></div>
<div style="display:flex;align-items:center;gap:0.9rem;margin-top:0.45rem;"><svg width="40" height="40" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#E9A27F"/><polyline points="12,23 19,30 32,15" fill="none" stroke="#fff" stroke-width="3.5" stroke-linecap="round" stroke-linejoin="round"/></svg><dl class="np-besluit " style="flex:1;"><dt>Afspraak</dt><dd>het kernteam werkt een voorstel uit voor een korte, stabiele ID per koppelingspecificatie naast de naam, zoals OC-PR, en voor beide richtingen van een koppeling in één specificatie (<a href="https://github.com/Npuls-OKx/Public/issues/107">Public #107</a>)</dd></dl></div>
<div style="display:flex;align-items:center;gap:0.9rem;margin-top:0.45rem;"><svg width="40" height="40" viewBox="0 0 44 44" style="flex:none;"><circle cx="22" cy="22" r="21" fill="#7A97F2"/><path d="M11 13 h22 a3 3 0 0 1 3 3 v11 a3 3 0 0 1 -3 3 h-12 l-6 5 v-5 h-4 a3 3 0 0 1 -3 -3 v-11 a3 3 0 0 1 3 -3 z" fill="#fff"/></svg><dl class="np-besluit kennisname" style="flex:1;"><dt>Naar Ruud en Hans</dt><dd>een aanpak op de vraag: wanneer zijn leveranciers het eens met ons verhaal, en welke rol spelen stories en pull requests daarin? Plus de tijdsbesteding, ver boven de afspraak. Ruud is met vakantie; follow-up na 30 september</dd></dl></div>
...
(13:51). Koppeling-ID: vraag van Kees (01:06); het kernteam werkt een voorstel uit, nog geen conventie
afgesproken; beide richtingen in één specificatie (01:08). Nabranders: Jan Hendrik vindt het nog veel over de vorm; Kees ziet goede stappen op koppelvlak,
